			...
			<div class="mt-4">
				...
				<div class="flex gap-4 items-center">
					<label class="flex items-center gap-2">
						<input type="radio" bind:group={dataSource} value="local" class="accent-black dark:accent-white" />
						<span class="text-sm">Local</span>
					</label>
					<label class="flex items-center gap-2">
						<input type="radio" bind:group={dataSource} value="eri" class="accent-black dark:accent-white" />
